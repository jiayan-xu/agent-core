...
def agent_headers() -> dict:
    # agent-core auth.rs 只接受 ASCII 头：含中文的 agent_id 按 PFAiX 惯例 percent-encode，
    # 服务端 percent_decode_agent_id 还原（auth.rs）。纯 ASCII id 原样透传。
    agent_id = require_credential("AGENTCORE_AGENT_ID")
